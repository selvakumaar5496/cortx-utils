...
class Replication:
    ...
    def addattribute(conn, dn, attr_to_add, value):
        ...
        try:
            ...
            Log.debug('Exception while adding '+ attr_to_add + ' to dn '+ dn)
                ...
                for value in result2[attr_to_delete]:
                    if(value):
                        ...
                        try:
                            ...
                            Log.debug('Exception while deleting '+attr_to_delete+ ' from dn '+ dn + ' value '+str(value) )
                            raise Exception('Exception while deleting '+attr_to_delete+ ' from dn '+ dn + ' value '+str(value) )
    ...
    def deleteattribute(conn, dn, attr_to_delete):
        ...
        try:
            ...
            Log.debug('Exception while deleting '+attr_to_delete+ ' from dn '+ dn  )
            raise Exception('Exception while deleting '+attr_to_delete+ ' from dn '+ dn  )
    ...
    def setreplication(hostfile, pwd):
        ...
        try:
            ...
            Log.debug('Exception while adding syncprov_mod')
        ...
        try:
            ...
            Log.debug('Exception while adding olcOverlay to data')
